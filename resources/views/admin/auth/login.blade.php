...
<html lang="en" class="light-style layout-wide customizer-hide" dir="ltr" data-theme="theme-default"
    data-assets-path="{{ URL::asset('') }}assets/" data-template="vertical-menu-template" data-style="light">
        ...
        <div class="authentication-inner row m-0">
            ...
            <div class="d-none d-lg-flex col-lg-8 p-0">
                <div class="auth-cover-bg auth-cover-bg-color d-flex justify-content-center align-items-center">
                    <img src="{{ URL::asset('') }}assets/img/illustrations/auth-login-illustration-light.png"
                        alt="auth-login-cover" class="my-5 auth-illustration"
                        data-app-light-img="illustrations/auth-login-illustration-light.png"
                        data-app-dark-img="illustrations/auth-login-illustration-dark.png" />

                    <img src="{{ URL::asset('') }}assets/img/illustrations/bg-shape-image-light.png"
            ...
            <div class="d-flex col-12 col-lg-4 align-items-center authentication-bg p-sm-12 p-6">
                <div class="w-px-400 mx-auto mt-12 pt-5">
                    <h4 class="mb-1">Selamat Datang di AIMS! 👋</h4>
                    <p class="mb-6">Silakan masuk ke akun Anda </p>

                    <form class="mb-6" action="{{ route('logininsert') }}" method="POST">
                        @csrf
                        <div class="mb-6">
