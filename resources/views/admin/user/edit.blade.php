                        ...
                        <form action="{{ route('user.update', $user->id) }}" method="POST">
                            ...
                            <div class="mb-6">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror"
                                    placeholder="Silahkan Isi" name="name" value="{{ old('name', $user->name) }}" />
                                @error('name')
                            ...
                            <div class="mb-6">
                                ...
                                <input type="email" class="form-control @error('email') is-invalid @enderror"
                                    placeholder="Silahkan Isi" name="email"
                            ...
                            <div class="mb-6">
                                ...
                                <select name="role" class="form-control @error('role') is-invalid @enderror">
                                    ...
                                    <option value="engineer"
                                        {{ old('role', $user->role) == 'engineer' ? 'selected' : '' }}>Engineer</option>
                                    <option value="surveyor"
                                        {{ old('role', $user->role) == 'surveyor' ? 'selected' : '' }}>Surveyor</option>
                                </select>
                                @error('role')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="mb-6">
                                ...
                                <input type="text" class="form-control @error('nip') is-invalid @enderror"
                                    placeholder="Silahkan Isi" name="nip" value="{{ old('nip', $user->nip) }}" />
                                @error('nip')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            </div>
