                    ...
                    <div class="card-body">
                        <form action="{{ route('aset.update', $aset->id) }}" method="POST">
                            ...
                            <div class="row">
                                    ...
                                    <div class="mb-6">
                                        ...
                                        <select name="jenis_aset" id="jenis_aset"
                                            ...
                                            <option value="pipeline"
                                                {{ old('jenis_aset', $aset->jenis_aset) == 'pipeline' ? 'selected' : '' }}>
                                                Pipeline</option>
                                            <option value="vessel"
                                                {{ old('jenis_aset', $aset->jenis_aset) == 'vessel' ? 'selected' : '' }}>
                                                Vessel</option>
                                            <option value="tangki timbun"
                                                {{ old('jenis_aset', $aset->jenis_aset) == 'tangki timbun' ? 'selected' : '' }}>
                                                Tangki Timbun</option>
                                        </select>
                                        @error('jenis_aset')
                                        ...
                                        <select name="area_id"
                                            ...
                                            @foreach ($areas as $area)
                                                <option value="{{ $area->id }}"
                                                    {{ old('area_id', $aset->area_id) == $area->id ? 'selected' : '' }}>
                                                    {{ $area->nama_area }}
                                                </option>
                                            @endforeach
                                        </select>
                                        ...
                                        <select name="cluster_id"
                                            ...
                                            @foreach ($clusters as $cluster)
                                                <option value="{{ $cluster->id }}"
                                                    {{ old('cluster_id', $aset->cluster_id) == $cluster->id ? 'selected' : '' }}>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-6">
                                        ...
                                        <textarea name="lokasi" class="form-control @error('lokasi') is-invalid @enderror" placeholder="Silahkan Isi">{{ old('lokasi', $aset->lokasi) }}</textarea>
                                        @error('lokasi')
                                            <div class="invalid-feedback d-block">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-6">
                                        ...
                                        <select name="tahun_dibuat"
                                            ...
                                            @for ($year = date('Y'); $year >= 1991; $year--)
                                                <option value="{{ $year }}"
                                                    {{ old('tahun_dibuat', $aset->tahun_dibuat) == $year ? 'selected' : '' }}>
                                                    {{ $year }}
                                                </option>
                                            @endfor
                                        </select>
                                    ...
                                    <div class="mb-6">
                                        ...
                                        <select name="status"
                                            ...
                                            <option value="aktif"
                                                {{ old('status', $aset->status) == 'aktif' ? 'selected' : '' }}>Aktif
                                            </option>
                                            <option value="tidak aktif"
                                                {{ old('status', $aset->status) == 'tidak aktif' ? 'selected' : '' }}>
                                                Tidak Aktif</option>
                                        </select>
                                        @error('status')
                                            <div class="invalid-feedback d-block">{{ $message }}</div>
                                    ...
                                    <div class="col-12">
                                        <div class="mb-6">
                                            ...
                                            <input type="text" name="distrik"
                                                ...
                                                value="{{ old('distrik', $aset->distrik) }}" />
                                            @error('distrik')
                                                <div class="invalid-feedback d-block">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-12">
                                        <div class="mb-6">
                                            ...
                                            <input type="text" name="dimensi"
                                                ...
                                                placeholder="Silahkan Isi"
                                                value="{{ old('dimensi', $aset->dimensi) }}" />
                                            @error('dimensi')
                                                <div class="invalid-feedback d-block">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-12">
                                        <div class="mb-6">
                                            ...
                                            <input type="text" name="lokasi_bentang"
                                                ...
                                                placeholder="Silahkan Isi"
                                                value="{{ old('lokasi_bentang', $aset->lokasi_bentang) }}" />
                                    ...
                                    <div class="col-12">
                                        <div class="mb-6">
                                            ...
                                            <input type="text" name="jenis_peralatan"
                                                ...
                                                placeholder="Silahkan Isi"
                                                value="{{ old('jenis_peralatan', $aset->jenis_peralatan) }}" />
                                    ...
                                    <div class="col-12">
                                        <div class="mb-6">
                                            ...
                                            <input type="text" name="tag_number"
                                                ...
                                                placeholder="Silahkan Isi"
                                                value="{{ old('tag_number', $aset->tag_number) }}" />
                                            @error('tag_number')
                                                <div class="invalid-feedback d-block">{{ $message }}</div>
                                            @enderror
                                        </div>
                            ...
                            <div class="mt-4">
                                ...
                                <a href="{{ route('aset.index') }}" class="btn btn-label-secondary">Batal</a>
                            </div>
                        </form>
                    </div>
                </div>
